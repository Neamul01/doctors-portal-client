...
const MakeAppointment = () => {
    return (
        <section className='flex justify-center items-center bg-appointment bg-cover mx-0 mt-40'>
            <div className='flex-1 hidden lg:block mt-[-130px]'>
                <img src={doctor} alt="" />
            </div>
